...
/** Reset NAP logic.
 * Note : does not currently reset NAP DCM's.
 */
void nap_reset()
{
 ...
 * Delays FPGA from using SPI2 lines and configuring itself as long as CONF B is low.
 */
...
/** Get the count of NAP's internal sample clock counter at the clock cycle the last timing_strobe went high.

...
# NOTE: Taken from ChibiOS-RT/os/ports/GCC/ARMCMx/rules.mk
# modified to remove -fsingle-precision-constant
...
LDFLAGS   = $(MCFLAGS) $(OPT) -nostartfiles $(LLIBDIR) -Wl,-Map=$(BUILDDIR)/$(PROJECT).map,--cref,--no-warn-mismatch -Wl,--library-path=$(CHIBIOS)/os/common/ports/ARMCMx/compilers/GCC -Wl,--script=$(LDSCRIPT)$(LDOPT)

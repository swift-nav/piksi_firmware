...
LDFLAGS   = $(MCFLAGS) $(OPT) -nostartfiles $(LLIBDIR) -Wl,-Map=$(BUILDDIR)/$(PROJECT).map,--cref,--no-warn-mismatch,--library-path=$(CHIBIOS)/os/common/ports/ARMCMx/compilers/GCC,--script=$(LDSCRIPT)$(LDOPT)

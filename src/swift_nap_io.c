...
void get_nap_parameters(){
  ...
  for (u8 i=0; i<sizeof(nap_parameters); i++){
  ...
  TRACK_CODE_PHASE_UNITS_PER_CHIP = ((u64)1<<TRACK_CODE_PHASE_WIDTH_FRACTIONAL);

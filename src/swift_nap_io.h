...
extern u8 ACQ_CARRIER_PHASE_WIDTH;
extern u8 ACQ_CARRIER_FREQ_WIDTH;
extern u8 ACQ_CODE_PHASE_WIDTH;
extern u8 ACQ_CORRELATOR_WIDTH;
extern u8 TRACK_CARRIER_PHASE_WIDTH;
extern u8 TRACK_CARRIER_FREQ_WIDTH;
extern u8 TRACK_CODE_PHASE_WIDTH_FRACTIONAL;
extern u8 TRACK_CODE_PHASE_RATE_WIDTH;
extern u8 TRACK_CORRELATOR_WIDTH;
extern u8 TRACK_INIT_CODE_PHASE_WIDTH;
extern u8 CW_CARRIER_PHASE_WIDTH;
extern u8 CW_CARRIER_FREQ_WIDTH;
extern u8 CW_CORRELATOR_WIDTH;
extern s8 IIR_COEF_LSB;
extern u8 IIR_COEF_MSB;
extern u8 IIR_N_TAPS;
